...
const Eventrental = () => {
  ...
  const artistData = [
    {
      title: "Book The Best Event Equipment For Eventrental In Indore", 
      artists: [
    ...
    {
      title: "Book Top Event Equipment For Eventrental In Indore",
      artists: [
    ...
    <div className="equipment-booking">
      <div className="artist-header text-white py-5 text-center">
        <div className="container">
          <h1 className="fw-bold">Book Top Event Equipment For Eventrental In Indore </h1>
          <p className="mt-3">
            Book live,Flood Light,LED Screen,DFMD,Baggage Scanner,CCTV Cameras,Carpets,PAR Light and more with GNV India. Find the perfect for your event in Indore.
          </p>
        </div>
      </div>
